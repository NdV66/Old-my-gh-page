define(function () {
    ...
    View.prototype = {
        ...
        createCard: function(result) {
            this.cardParent.append('<div id="' + result.name + '" class="card slideanim col-md-12 col-sm-12 col-xs-12">' +
                                        '<div class="panel panel-default text-left">' +
                                            '<div class="panel-heading"><a href="' + result.url + '" target="_blank"><h2>' + result.name + '</h2></a></div>'+
